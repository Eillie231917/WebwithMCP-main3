...
# ─────────── 1. 大模型配置 ───────────
MODEL_CONFIG = {
    "api_key": "9c95e8154b2847dba26e16ac466c8e87.A8AmXvyyPeWJbhqM",  # ← 改为您的API Key
    "base_url": "https://open.bigmodel.cn/api/paas/v4/",  # ← 改为您的API地址
    "model_name": "glm-4.5-flash",  # ← 改为您的模型名称
    "temperature": 0.2,
    "timeout": 60
}
# ─────────── 2. MCP配置管理 ───────────
